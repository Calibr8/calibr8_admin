...
namespace Drupal\calibr8_admin\Plugin\Field\FieldWidget;
...
/**
 * Defines the 'calibr8_admin_entity_browser' field widget.
 *
 * @FieldWidget(
 *   id = "calibr8_admin_entity_browser_in_sidebar",
